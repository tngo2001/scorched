    ...
    return (
      <div className="section dark-bg">
        ...
        <div ref={firesRef} className='hidden'>
          <div className='tableauPlaceholder' id='viz1669614729428' style={{margin: 'auto'}}>
            <noscript><a href='/#'><img alt='Which States Are Most Affected by Wildfires? ' src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;CS&#47;CSE442FP&#47;Fires&#47;1_rss.png' style={{border: 'none'}} /></a></noscript>
            <object className='tableauViz'  style={{display: 'none'}}>
                <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
                <param name='embed_code_version' value='3' />
          ...
          <Helmet>
            <script type='text/javascript'>
              var divElement = document.getElementById('viz1669614729428');
              var vizElement = divElement.getElementsByTagName('object')[0];
              vizElement.style.width = '100vh';
              vizElement.style.height = '75vh';
              var scriptElement = document.createElement('script');
