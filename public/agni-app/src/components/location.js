...
export const Location = () => {
    return (
      ...
      <p className="layoutTwo">Many communities are developed and developing on lands that are naturally prone to wildfires. This means that even more people and homes will be in harm's way.</p>
      </div>);
  };
